...
const Login = () => {
  ...
  const handleGoogleAuth = async () => {
    setLoading(true)
    try {
      // Mock Google OAuth SSO response sync
      const googleUser = {
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        <div className="glass-panel" style={{
          ...
          {/* Google SSO Button */}
          <button onClick={handleGoogleAuth} className="btn-google" style={{ marginBottom: '24px' }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: '0.75rem', color: '#64748b', fontWeight: 600 }}>OR WITH EMAIL</span>
            <div style={{ flex: 1, height: '1px', backgroundColor: 'rgba(255, 255, 255, 0.1)' }} />
          </div>
          ...
          <p style={{ textAlign: 'center', fontSize: '0.85rem', color: '#94a3b8', marginTop: '24px' }}>
